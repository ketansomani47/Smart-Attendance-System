...
public class ParentVerification extends AppCompatActivity {
    ...
    private void getParentId() {
        ...
        parentId=pref.getInt("ParentId",0);
    }

    private void getMobileNo() {
        MySqliteOpenHelper mysqliteHelper=new MySqliteOpenHelper(ParentVerification.this);
        SQLiteDatabase database=mysqliteHelper.getReadableDatabase();
        String sel= Student.ID + "='" + parentId + "'";
        Cursor cur=Student.select(database,sel);
    ...
    private void sendMessage() {
        StringRequest request=new StringRequest(Request.Method.GET, "https://control.msg91.com/api/sendhttp.php?authkey=164884A6wNlivfz5965b2a9&mobiles=" + mobile + "&message=" + otp + "&sender=ABCDEF&route=4&country=91 ", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                Toast.makeText(ParentVerification.this, "Message Sent", Toast.LENGTH_SHORT).show();

            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(ParentVerification.this, "Network Error", Toast.LENGTH_SHORT).show();
    ...
    private void submit() {
        ...
        if(enteredOtp.equals("")){
            ...
            if (enteredOtp.equals(otp)) {
                ...
                editTextOtp.setText("");
                Intent i = new Intent(ParentVerification.this, ParentChangePassword.class);
                startActivity(i);
                finish();
            } else {
